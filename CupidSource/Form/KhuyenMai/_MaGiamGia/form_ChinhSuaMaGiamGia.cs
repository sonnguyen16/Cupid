...
namespace Cupid
{
    public partial class form_ChinhSuaMaGiamGia : Form
    {
        string tk;
        bool check_giaodien, check_ngonngu;
        DataGridViewRow row;
        public form_ChinhSuaMaGiamGia(DataGridViewRow row, string tk)
        {
            InitializeComponent();
            this.tk = tk;
            UpdateColorApp();
        ...
        private void button_ChinhSua_Click(object sender, EventArgs e)
        {
            if (KiemTra())
            {
                ...
                bool data = MaGiamGiaDAO.Instance.SuaMaGiamGia(textbox_MaGiamGia.Texts, float.Parse(textbox_GiamGia.Texts), dt1, dt2);
                if (data)
                {
                    this.Close();
                    var f = (form_KhuyenMai)this.Owner;
                    f.dataGridView1.DataSource = MaGiamGiaDAO.Instance.getMaGiamGia();
                    f.dataGridView1.ClearSelection();
                    f.vt = -1;
                    f.OnOffBtn(false);
                }
        ...
        private bool KiemTra()
        {
            if (!check_ngonngu)
            {
                ...
                if (textbox_MaGiamGia.Texts.Trim().Equals(""))
                {
                    label_Loi.Text = "Bạn chưa nhập mã giảm giá";
                    return false;
                }
                if (textbox_GiamGia.Texts.Trim().Equals(""))
                {
                    label_Loi.Text = "Bạn chưa nhập % giảm";
                    return false;
                }
            ...
            else
            {
                ...
                if (textbox_MaGiamGia.Texts.Trim().Equals(""))
                {
                    label_Loi.Text = "You have not entered the discount code";
                    return false;
                }
                if (textbox_GiamGia.Texts.Trim().Equals(""))
                {
                    label_Loi.Text = "You have not entered % reduction";
                    return false;
                }
                int a = DateTime.Compare(dateTimePicker_NgayKetThuc.Value, dateTimePicker_NgayBatDau.Value);
                if (a < 0)
        ...
        private void textbox_GiamGia_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void form_ChinhSuaMaGiamGia_Load(object sender, EventArgs e)
        {
            textbox_MaGiamGia.Texts = row.Cells[0].Value.ToString();
            textbox_GiamGia.Texts = row.Cells[1].Value.ToString();
        ...
        public void Change_Color_White()
        {
            ...
            //Textbox
            textbox_MaGiamGia.BackColor = CaiDatDAO.Instance.color_BG_White_01;
            textbox_MaGiamGia.ForeColor = CaiDatDAO.Instance.color_Text_White_02;
            textbox_MaGiamGia.PlaceholderColor = CaiDatDAO.Instance.color_Text_DarkGray;

            textbox_GiamGia.BackColor = CaiDatDAO.Instance.color_BG_White_01;
            textbox_GiamGia.ForeColor = CaiDatDAO.Instance.color_Text_White_02;
            textbox_GiamGia.PlaceholderColor = CaiDatDAO.Instance.color_Text_DarkGray;
        ...
        public void Change_Color_Black()
        {
            ...
            //Textbox
            textbox_MaGiamGia.BackColor = CaiDatDAO.Instance.color_BG_Black_01;
            textbox_MaGiamGia.ForeColor = CaiDatDAO.Instance.color_Text_Black_02;
            textbox_MaGiamGia.PlaceholderColor = CaiDatDAO.Instance.color_Text_DarkGray;

            textbox_GiamGia.BackColor = CaiDatDAO.Instance.color_BG_Black_01;
            textbox_GiamGia.ForeColor = CaiDatDAO.Instance.color_Text_Black_02;
            textbox_GiamGia.PlaceholderColor = CaiDatDAO.Instance.color_Text_DarkGray;
        ...
        {
            //Label
            label_Title.Text = "Tạo giảm giá";
            label_Den.Text = "đến";
            //Textbox
            textbox_MaGiamGia.PlaceholderText = "Mã giảm giá";
            textbox_GiamGia.PlaceholderText = "% được giảm giá";
        ...
        private void textbox_GiamGia_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && (Keys)e.KeyChar != Keys.Back && e.KeyChar != '.')
            {
                e.Handled = true;
        ...
        public void Change_Language_EN()
        {
            ...
            //Label
            label_Title.Text = "Edit a discount";
            label_Den.Text = "to";
            //Textbox
            textbox_MaGiamGia.PlaceholderText = "Discount code";
            textbox_GiamGia.PlaceholderText = "% discount";
        ...
        public void UpdateColorApp()
        {
            ...
            textbox_MaGiamGia.BorderColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
            textbox_MaGiamGia.BorderFocusColor = CaiDatDAO.Instance.color_BG_ColorApp_01;

            textbox_GiamGia.BorderColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
            textbox_GiamGia.BorderFocusColor = CaiDatDAO.Instance.color_BG_ColorApp_01;
