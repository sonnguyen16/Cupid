...
namespace Cupid
{
    public partial class form_XoaMaGiamGia : Form
    {
        string magg;
        string tk;
        bool check_giaodien, check_ngonngu;
        public form_XoaMaGiamGia(string magg, string tk)
        {
            InitializeComponent();
            this.tk = tk;
        ...
        {
            MaGiamGiaDAO.Instance.XoaMaGiamGia(magg);
            this.Close();
        ...
        private void form_XoaMaGiamGia_Load(object sender, EventArgs e)
        {
        ...
        public void Change_Language_VI()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Bạn có chắc chắn muốn xóa mã giảm giá này?";
            //Button
        ...
        public void Change_Language_EN()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Are you sure you want to delete this discount code?";
            //Button
