...
namespace Cupid
{
    public partial class form_XoaKhuyenMai : Form
    {
        string makm;
        string tk;
        bool check_giaodien, check_ngonngu;
        public form_XoaKhuyenMai(string Makm, string tk)
        {
            InitializeComponent();
            this.tk = tk;
        ...
        {
            KhuyenMaiDAO.Instance.XoaKhuyenMai(makm);
            this.Close();
        ...
        private void form_XoaKhuyenMai_Load(object sender, EventArgs e)
        {
        ...
        public void Change_Language_VI()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Bạn có chắc chắn muốn xóa khuyến mãi này?";
            //Button
        ...
        public void Change_Language_EN()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Are you sure you want to delete this promotion?";
            //Button
