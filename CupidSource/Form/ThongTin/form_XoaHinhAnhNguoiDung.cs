...
namespace Cupid
{
    public partial class form_XoaHinhAnhNguoiDung : Form
    {
        string tk;
        bool check_giaodien, check_ngonngu;
        public form_XoaHinhAnhNguoiDung(string tk)
        {
            InitializeComponent();
            this.tk = tk;
        ...
        private void form_XoaHinhAnhNguoiDung_Load(object sender, EventArgs e)
        {
        ...
        {
            var f = (form_HinhAnhNguoiDung)this.Owner;
            f.XoaHinhAnh();
            this.Close();
        }
        ...
        public void Change_Language_VI()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Bạn có chắc chắn muốn xóa hình ảnh này của người dùng?";
            //Button
        ...
        public void Change_Language_EN()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Are you sure you want to delete this user's image?";
            //Button
