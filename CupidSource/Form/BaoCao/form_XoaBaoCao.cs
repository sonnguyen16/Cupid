...
namespace Cupid
{
    public partial class form_XoaBaoCao : Form
    {
        string tk;
        bool check_giaodien, check_ngonngu;
        public form_XoaBaoCao(string tk)
        {
            InitializeComponent();
        ...
        private void button_DongY_Click(object sender, EventArgs e)
        {
            ...
            BaoCaoDAO.Instance.XoaBaoCao(f.row.Cells[0].Value.ToString());
        ...
        private void form_XoaBaoCao_Load(object sender, EventArgs e)
        {
        ...
        public void Change_Language_VI()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Bạn có chắc chắn muốn xóa báo cáo của người dùng này?";
            //Button
        ...
        public void Change_Language_EN()
        {
            ...
            //Textbox
            label_NoiDung.Text = "Are you sure you want to delete this user's report?";
            //Button
