...
namespace Cupid
{
    class DateTimePicker_Custom : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = Cupid.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Cupid.Properties.Resources.calendarDark;
                else calendarIcon = Cupid.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
