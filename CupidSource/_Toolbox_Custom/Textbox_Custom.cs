...
namespace Cupid.Toolbox_Custom
{
    ...
    public partial class Textbox_Custom : UserControl
    {
        #region -> Fields
        //Fields
        private Color borderColor = Color.FromArgb(157, 217, 243);
        private Color borderFocusColor = Color.FromArgb(119, 195, 236);
        ...
        public static explicit operator Textbox_Custom(bool v)
        {
